...
<div class="form-group">
    ...
    <div class="form-check @error('status') is-invalid  @enderror">
        <input {{ 1 == old('status', $story->status) ? 'checked' : '' }} type="radio" class="form-check-input" name="status" value="1">
        <label for="active" class="form-check-label">Yes</label>
    </div>

    <div class="form-check">
        <input {{ 2 == old('status', $story->status) ? 'checked' : '' }} type="radio" class="form-check-inpu t" name="status" value="0">
